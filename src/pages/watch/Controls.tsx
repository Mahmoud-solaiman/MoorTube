    ...
    <div onTouchEnd={e => e.stopPropagation()} className={isShowControls ? "controls-container" : "controls-container hidden"} >
      ...
      <div className="custom-controls" >
        ...
        <div className="settings-btn">
          <svg className={isSettings ? "settings-toggled" : ""} onClick={() => setIsSettings(!isSettings)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
        ...
        <FullscreenButton>
          ...
          {
            isFullScreen ?
              <svg className="exit-fullscreen" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
